...
import { FILL_MESSAGE, VAILD_MESSAGE, PASSWORD_INVALID, NOT_REGITERED } from '../common/constMessage';
export default class Login extends Component {
    ...
    // User validtion and authentication //
    handleRegisterUser = () => {
                            ...
                            <View style={styles.inputsContainer}>
                                ...
                                <View style={[styles.inputs, { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }]}>
                                    ...
                                    <TouchableOpacity onPress={() => this.showPasswordText()}>
                                        <Text style={{ paddingRight: wp('3%'), color: color.WHITE, justifyContent: 'center', alignItems: 'center' }}>{this.state.showPassword ? <Icon
                                            name="eye"
                                            size={25}
                                            style={{}} /> : <Icon
                                                name="eye-with-line"
